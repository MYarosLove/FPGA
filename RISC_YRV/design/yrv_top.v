...
/* options                                                                                 */
`include "design/yrv_opt.v"

/* standard csr addresses                                                                  */
`include "design/define_csr.v"
/* control/status registers                                                                */
`include "design/yrv_csr.v"


/* instruction opcodes                                                                     */
`include "design/define_dec.v"
/* exception codes                                                                         */
`include "design/define_ec.v"
/* interrupt control                                                                       */
`include "design/yrv_int.v"
/* cpu                                                                                     */
`include "design/yrv_cpu.v"
...
module yrv_top  (csr_achk, csr_addr, csr_read, csr_wdata, csr_write, debug_mode, ebrk_inst,
  ...
  yrv_cpu CPU  ( .csr_achk(csr_achk), 
                 ...
                 .bus_32(bus_32), 
					  ...
					  .csr_idata(csr_idata), 
					  .csr_rdata(csr_rdata),
                 .csr_ok_ext(csr_ok_ext), 
					  .csr_ok_int(csr_ok_int), 
					  .dbg_req(dbg_req),
                 .ebrkd_reg(ebrkd_reg), 
					  .halt_reg(halt_reg), 
					  .irq_bus(irq_bus),
  ...
  /* control/status registers                                                              */
  /*****************************************************************************************/
  yrv_csr CSR  ( .csr_idata(csr_idata), 
					  .csr_ok_int(csr_ok_int), 
					  .cycle_ov(cycle_ov),
                 .ebrkd_reg(ebrkd_reg), 
					  .instret_ov(instret_ov), 
					  .meie_reg(meie_reg),
                 .mie_reg(mie_reg), 
					  .mlie_reg(mlie_reg), 
					  .msie_reg(msie_reg),
